...
CREATE TABLE IF NOT EXISTS `headhunter`.`hr_profiles` (
  ...
  CONSTRAINT `fk_hr_profiles_hr_available_permissions1`
    ...
    REFERENCES `headhunter`.`hr_available_permissions` (`id_hr_permissions`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `headhunter`.`hr_users` (
  ...
  CONSTRAINT `fk_hr_users_hr_profiles1`
    ...
    REFERENCES `headhunter`.`hr_profiles` (`id_hr_profiles`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `headhunter`.`vacancy` (
  ...
  CONSTRAINT `fk_vacancy_hr_users1`
    ...
    REFERENCES `headhunter`.`hr_users` (`hr_id` , `hr_available_permissions_hr_id` , `hr_profiles_hr_phone_country` , `vacancy_id_vacancy`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vacancy_response1`
    FOREIGN KEY (`response_id_response`)
    REFERENCES `headhunter`.`response` (`id_response`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
