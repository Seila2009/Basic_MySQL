...
CREATE TABLE IF NOT EXISTS `headhunter`.`hr_available_permissions` (
  ...
  INDEX `fk_hr_available_permissions_hr_users1_idx` (`hr_users_hr_id` ASC, `hr_users_hr_available_permissions_hr_id` ASC, `hr_users_hr_profiles_hr_phone_country` ASC, `hr_users_vacancy_id_vacancy` ASC) VISIBLE,
  CONSTRAINT `fk_hr_available_permissions_hr_users1`
...
CREATE TABLE IF NOT EXISTS `headhunter`.`vacancy` (
  ...
  INDEX `fk_vacancy_hr_users1_idx` (`hr_users_hr_id` ASC, `hr_users_hr_available_permissions_hr_id` ASC, `hr_users_hr_profiles_hr_phone_country` ASC, `hr_users_vacancy_id_vacancy` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `headhunter`.`counters` (
  ...
  INDEX `fk_counters_vacancy1_idx` (`vacancy_id_vacancy` ASC, `vacancy_counters_id_vacancy_counters` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `headhunter`.`skills` (
  ...
  INDEX `fk_skills_vacancy1_idx` (`vacancy_id_vacancy` ASC, `vacancy_counters_id_vacancy_counters` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `headhunter`.`resume_search` (
  ...
  `hr_users_hr_profiles_hr_phone_country` VARCHAR(100) NOT NULL,
  `hr_users_vacancy_id_vacancy` INT NOT NULL,
  INDEX `fk_resume_search_hr_users1_idx` (`hr_users_hr_id` ASC, `hr_users_hr_available_permissions_hr_id` ASC, `hr_users_hr_profiles_hr_phone_country` ASC, `hr_users_vacancy_id_vacancy` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `headhunter`.`media` (
  ...
  PRIMARY KEY (`id_vacancy`),
  INDEX `fk_media_vacancy1_idx` (`vacancy_id_vacancy` ASC, `vacancy_counters_id_vacancy_counters` ASC) VISIBLE,
